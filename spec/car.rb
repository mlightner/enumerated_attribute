...
class Vehicle
  def vehicle_method_missing_called?;
    @vehicle_method_missing_called;
  end

  def self.vehicle_new_called?;
    @@vehicle_new_called;
  end
...
class CarWithMethods < Vehicle
  def car_method_missing_called?;
    @car_method_missing_called;
  end

  def self.car_new_called?;
    @@car_new_called;
  end

  def self.reset;
    @@car_new_called = false; super;
  end
